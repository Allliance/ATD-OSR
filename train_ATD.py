...
from data.open_set import get_out_training_loaders, get_out_training_loaders_osr
...
for epoch in range(num_epochs):
    ...
    with tqdm(zip(trainloader, trainloader_out)) as tq:
        for i, ((x, y), (x_out, y_out)) in enumerate(tq, 0):
